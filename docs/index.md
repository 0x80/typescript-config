...
The `shared-library` and `shared-library-react` configs enable `composite`, `declaration`, and `declarationMap` because project references require TypeScript to emit declarations. Your bundler still handles the JavaScript output.
:::
